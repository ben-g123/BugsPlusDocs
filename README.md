...
<i class="fa-building-user">:building-user:</i> _Bugs+ HQ Location_: **It is in a table in The Hub at City Vista Ct, Fraser Rise VIC 3336 (Springside West). It should also have a sign in one of the tables. Access only to students and teachers/staff of Springside West. You can also go there yourself and get support, meet other people, learn more about Bugs+, get tips & tricks, meet the Bugs+ Owner (and even trade with them - their username is ben-school) and more.**
